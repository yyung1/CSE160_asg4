...
Vector3.prototype.add = function(v) {
  if (!v || !v.elements) {
    console.error("add() received invalid vector:", v);
    return this;
  }
...
/** Subtract another Vector3 in-place */
Vector3.prototype.sub = function(v) {
  if (!v || !v.elements) {
    console.error("sub() received invalid vector:", v);
    return this;
  }
  this.elements[0] -= v.elements[0];
  this.elements[1] -= v.elements[1];
...
Vector3.cross = function(a, b) {
  let e1 = a.elements, e2 = b.elements;
